...
class UserCommandToUserEntityConverterTest {

    @InjectMocks
    private UserCommandToUserEntityConverterImpl userCommandToUserEntityConverter;
    ...
    public void testConvert() {
        UserCommand source = new UserCommand()
                ...
                .setAge(18);
        UserEntity result = userCommandToUserEntityConverter.convert(source);
